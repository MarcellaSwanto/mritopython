...
% Gradient Grid             
    ...
    [pathstr,name,ext]=fileparts('D:\_UNI\2k19\_UROP\guiless\mritopython-master\MRiLab-GUILess\Grad_LinearHead.XML');
...
if VObj.SpinNum >1
    ...
    [pathstr,name,ext]=fileparts('D:\_UNI\2k19\_UROP\guiless\mritopython-master\MRiLab-GUILess\Mag_LinearHead.XML');
    eval(['dB0=' name ';']);
    VMag.dB0=dB0;
...
%Transmitter coil code
    ...
    [pathstr,name,ext]=fileparts('D:\_UNI\2k19\_UROP\guiless\mritopython-master\MRiLab-GUILess\Coil_8ChHead.xml');
