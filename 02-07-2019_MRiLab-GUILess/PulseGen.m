...
seqdir='D:\_UNI\2k19\_UROP\guiless\mritopython-master\MRiLab-GUILess\PSD_GRE3D.xml';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
VSeq.rfCoilLine=ones(size(rfCoilLine)); % force to convert rfCoilLine to 1 for single Tx - simplified as multi-transmit will 
%always be off

% Do grad amplitude & slew rate check
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%All of the below variables are hardcoded for the scanning parameters
%mentioned before for the DoGradChk file. Code doesn't work without it... 
VCtl.MaxGrad = 0.0500;
